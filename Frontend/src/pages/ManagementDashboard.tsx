...
import { Clock, CurrencyInr, ChartLineUp, CheckCircle, Funnel, Sparkle, Target } from '@phosphor-icons/react';
...
const ManagementDashboard = () => {
  ...
  const computedRFPs = useMemo(() => {
    const maxValue = Math.max(...mockRFPs.map((rfp) => parseValueToCrores(rfp.value)), 1);
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
          <div className="bg-white p-6 rounded-xl shadow-md shadow-slate-100 border border-slate-200 flex flex-col h-full transition-transform duration-200 hover:-translate-y-1 hover:shadow-lg">
            <div className="flex items-center justify-between mb-4">
              ...
              <CurrencyInr size={20} weight="duotone" className="text-teal-600" />
            </div>
            <p className="text-3xl font-bold text-navy-900">₹{totalPipelineValue.toFixed(1)}Cr</p>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md shadow-slate-100 border border-slate-200 flex flex-col h-full transition-transform duration-200 hover:-translate-y-1 hover:shadow-lg">
            <div className="flex items-center justify-between mb-4">
              ...
              <ChartLineUp size={20} weight="duotone" className="text-navy-700" />
            </div>
            ...
            <div className="px-6 py-4 flex flex-wrap items-center gap-3 bg-slate-50 border-b border-slate-200">
              ...
              <div className="flex gap-2 items-center">
                <button
                  ...
                  className={`text-sm px-3 py-2 rounded-lg border transition duration-150 active:scale-[0.98] ${focusFilter === 'quickWins'
                ...
                <button
                  ...
                  className={`text-sm px-3 py-2 rounded-lg border transition duration-150 active:scale-[0.98] ${focusFilter === 'strategicBets'
                ...
                <button
                  ...
                  className={`text-sm px-3 py-2 rounded-lg border transition duration-150 active:scale-[0.98] ${focusFilter === 'all'
              ...
              <button
                ...
                className={`text-sm px-3 py-2 rounded-lg border transition duration-150 active:scale-[0.98] overflow-hidden relative group ${riskFilter === 'high'
                ...
                <tbody className="bg-white">
                  {filteredRFPs.map((rfp) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`px-2.5 py-1 rounded-full text-xs font-medium ${rfp.waitingOn === 'completed'
